...
layout: page
title: "/wireshark"
permalink: "/writeups/tryhackme/wireshark/"
platform: "TryHackMe"
writeup_type: "room"
room_name: "Wireshark"
---
...
<section class="page-hero panel">
  <p class="eyebrow">root@rumais:~# inspect wireshark</p>
  <h1>Wireshark</h1>
...
- Wireshark rewards careful note-taking and stepwise validation rather than trial-and-error execution.
...
Manual writeup expansion is still pending. The folder currently contains limited or non-text artifacts, so this page is holding the room position in the archive until the workflow notes are rebuilt.
